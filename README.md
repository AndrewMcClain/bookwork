...
- **Imposed** — the actual sheets, plus settings: signature size, sheet size,
  margin, gutter, crop marks, endpapers, wrap cover, and whether to pad the
  last signature. Named presets persist across runs.
